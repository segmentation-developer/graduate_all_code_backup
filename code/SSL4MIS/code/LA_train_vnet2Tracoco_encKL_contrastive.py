...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            enc5_contrastive_loss = info_nce_loss(features1 = dsv5_F_soft[args.labeled_bs:], features2 = dsv5_S_soft[args.labeled_bs:])



            supervised_loss= (loss1 + loss2)/2
            unsupervised_loss =  consistency_weight *((consistency_loss_aux1+ consistency_loss_aux2+ consistency_loss_aux3+consistency_loss_aux4 + enc5_contrastive_loss)/5)
            ...
            wandb.log({
                ...
                "enc5_contrastive_loss": enc5_contrastive_loss.item(),

            })

            logging.info('iteration %d : supervised_loss : %f  unsupervised_loss : %f enc5_contrastive_loss: %f'  % (
                iter_num, supervised_loss.item(), unsupervised_loss.item(),  enc5_contrastive_loss.item()))
