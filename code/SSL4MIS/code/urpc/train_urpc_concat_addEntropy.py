...
from networks.unet_3D_dv_semi_concat import unet_3D_dv_semi
from utils import losses, metrics, ramps
from val_urpc_concat_util import test_all_case
import wandb
...
parser.add_argument('--patch_size',nargs='+', type=int,  default=[128, 128, 80],
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs_aux1, outputs_aux2, outputs_aux3, outputs_aux4, preds = model(
                volume_batch)
            ...
            logging.info(
                ...
                (iter_num, loss.item(), supervised_loss.item(), consistency_loss_aux1.item(),
                 ...
                 torch.mean(variance_aux1).item(), torch.mean(variance_aux2).item(), torch.mean(variance_aux3).item(),
