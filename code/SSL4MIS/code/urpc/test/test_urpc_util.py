    ...
    for x in range(0, sx):
        ...
        for y in range(0, sy):
            ...
            for z in range(0, sz):
                ...
                with torch.no_grad():
                    y_main, y_aux1, y_aux2, y_aux3,_,_,_,_ = net(test_patch)
...
def test_all_case(net, base_dir, method="unet_3D", test_list="full_test.list", num_classes=4, patch_size=(48, 160, 160),
                  stride_xy=32, stride_z=24, save_result=True, test_save_path=None, metric_detail=0 , nms=0):
