    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs_aux1, outputs_aux2, outputs_aux3, outputs_aux4 = model(
                volume_batch)
            outputs_aux1_soft = torch.softmax(outputs_aux1, dim=1)          # bs=4
            outputs_aux2_soft = torch.softmax(outputs_aux2, dim=1)          # bs=4
            outputs_aux3_soft = torch.softmax(outputs_aux3, dim=1)          # bs=4
            outputs_aux4_soft = torch.softmax(outputs_aux4, dim=1)          # bs=4
