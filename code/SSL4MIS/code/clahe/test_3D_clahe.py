...
from test_3D_util_clahe import test_all_case
...
def Inference(FLAGS):
    ...
    save_mode_path = os.path.join(
        snapshot_path, 'model2_iter_36000_dice_0.8865.pth')
    #save_mode_path = os.path.join(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp', type=str,
                        default='LA/claheNormalize_CTB_unetVnet_cropMse_SLboundary', help='experiment_name')
    parser.add_argument('--exp_test', type=str,
                        default='LA_test/claheNormalize_CTB_unetVnet_cropMse_SLboundary', help='experiment_name')
