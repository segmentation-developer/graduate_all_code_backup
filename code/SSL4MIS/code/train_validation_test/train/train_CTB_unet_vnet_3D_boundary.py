    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if epoch_num == 200:
                ...
                # for idx in range(3):
                plt.subplot(6, 1, 1)
                plt.imshow(boundary1[0][:, :, 70:71])
                plt.subplot(6, 1, 2)
                plt.imshow(boundary2[0][:, :, 70:71])
            ...
            crop_mseLoss = 1 * torch.mean((aux_outputs_soft1[args.labeled_bs:]-aux_outputs_soft2[args.labeled_bs:]) ** 2)
            ...
            logging.info('iteration %d : supervised_loss : %f boundary_loss : %f unsupervised_loss : %f mseLoss1 : %f mseLoss2 : %f crop_mseLoss : %f'  % (
                iter_num, supervised_loss.item(), boundary_loss.item(), unsupervised_loss.item(),mseLoss1.item(),mseLoss2.item(),crop_mseLoss.item()))
