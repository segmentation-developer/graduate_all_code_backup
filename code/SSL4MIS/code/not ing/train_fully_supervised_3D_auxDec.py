...
parser.add_argument('--model', type=str,
                    default='vnet_auxDec', help='model_name')
...
def train(args, snapshot_path):
    ...
    num_classes = 2
    model = net_factory_3d(net_type=args.model, in_chns=1, class_num=num_classes)  # seg class = 2
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs, outputs_aux1, outputs_aux2 = model(volume_batch, mode='dec')
            ...
            loss = (loss_dice + loss_dice_aux1 + loss_dice_aux2 + loss_ce + loss_ce_aux1+ loss_ce_aux2) / 6
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
