...
parser.add_argument('--exp', type=str,
                    default='hBrain', help='experiment_name')
...
parser.add_argument('--seed', type=int,  default=1339, help='random seed')
...
def train(args, check_path):
    ...
    model = VNet(n_channels= 1 , n_classes=num_classes,
                   normalization='batchnorm', has_dropout=True).cuda() # seg class = 2
