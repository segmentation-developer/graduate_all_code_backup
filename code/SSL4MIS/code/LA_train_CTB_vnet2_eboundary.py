...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            exp_boundary_loss1 = torch.exp(-boundary_loss1)
            exp_boundary_loss2 = torch.exp(-boundary_loss2)
            boundary_loss = 0.1 * (exp_boundary_loss1 + exp_boundary_loss2)
            ...
            logging.info('iteration %d : supervised_loss : %f boundary_loss : %f unsupervised_loss : %f  cross_loss1: %f cross_loss2: %f'  % (
                iter_num, supervised_loss.item(), boundary_loss.item(), unsupervised_loss.item(), pseudo_supervision1.item(), pseudo_supervision2.item()))
