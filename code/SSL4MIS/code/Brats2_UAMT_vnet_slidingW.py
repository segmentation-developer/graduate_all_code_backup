...
from dataloaders.brats.brats2019_nii import (BraTS2019, RandomCrop,CenterCrop,
...
from brats_val_3D_nii import test_all_case
import wandb
...
parser.add_argument('--root_path', type=str,
                    default='/data/sohui/BraTS/data/brats19_2class_nii_normPad', help='Name of Experiment')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            consistency_dist = losses.softmax_mse_loss(
                outputs[labeled_bs:], ema_output)  # (batch, 2, 112,112,80)
