...
from networks.unet_3D_dsv import unet_3D
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            dsv1_F, dsv2_F, dsv3_F, dsv4_F= model1(volume_batch + noise )
            ...
            noise = torch.clamp(torch.randn_like(volume_batch) * 0.1, -0.2, 0.2)
            dsv1_S, dsv2_S, dsv3_S, dsv4_S= model2(volume_batch + noise )
            ...
            unsupervised_loss =  consistency_weight *((consistency_loss_aux1+ consistency_loss_aux2+ consistency_loss_aux3+consistency_loss_aux4 )/4)
