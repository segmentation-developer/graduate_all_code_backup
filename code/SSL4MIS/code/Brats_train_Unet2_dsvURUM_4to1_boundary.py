...
parser.add_argument('--exp', type=str,
                    default='brats19_result/test', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    model2 = unet_3D(n_classes=num_classes, in_channels=1).cuda()
    model1.train()
    model2.train()
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            supervised_loss= (loss1 + loss2 + boundary_loss)/3
            unsupervised_loss =  consistency_weight *(consistency_loss_aux1)
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/sohui/BraTS/data/{}/{}".format(args.exp, args.model)
