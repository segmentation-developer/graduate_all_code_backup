...
parser.add_argument('--root_path', type=str,
                    default='/data/sohui/pancreas/Task07_Pancreas', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='pan_result/Unet2_SL', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=24,
                    help='labeled data')
parser.add_argument('--total_labeled_num', type=int, default=282,
...
def train(args, snapshot_path):
    ...
    train_transforms = Compose(
        [
            ...
            SpatialPadd(keys=["image", "label"], spatial_size=(96,96,96), mode="constant"),  #d: 48~144
            RandCropByPosNegLabeld(
                keys=["image", "label"],
                label_key="label",
                spatial_size=(96,96,96),  #512,512,49 -> 160,160,48
                pos=1,
                neg=1,
                num_samples=1,
                image_key="image",
    ...
    val_transforms = Compose(
        [
            ...
            ScaleIntensityRanged(
                keys=["image"], a_min=-1024, a_max=2000, b_min=0.0, b_max=1.0, clip=True
            ),
    ...
    train_files, val_files = datalist[:-60], datalist[-60:]   # 222,60
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/sohui/pancreas/{}/{}".format(args.exp, args.model)
