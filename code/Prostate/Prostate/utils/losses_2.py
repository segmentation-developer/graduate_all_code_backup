...
def save_sdf(gt_path=None):
    ...
    dir_path = 'C:/Seolen/PycharmProjects/semi_seg/semantic-semi-supervised-master/denseUnet_3D/gan_sdfloss3D_0229_04/test'
...
# gt_sdf [2,2,112,112,80]  outputs_soft[2,2,112,112,80]
