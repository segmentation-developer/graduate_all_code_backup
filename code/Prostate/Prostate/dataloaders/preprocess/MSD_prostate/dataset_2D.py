...
from Prostate import augmentations
from Prostate.augmentations.ctaugment import OPS
...
class BaseDataSets(Dataset):
    def __init__(
        ...
        if self.split == "train":
            ...
            with open(self._base_dir + "/test_slices.list", "r") as f:
    ...
    def __getitem__(self, idx):
        ...
        if self.split == "train":
            h5f = h5py.File(self._base_dir + "/label_data/{}".format(case), "r")
        else:
            h5f = h5py.File(self._base_dir + "/label_data/{}".format(case), "r")
        image = h5f["image"][:]
        label = h5f["label"][:]
