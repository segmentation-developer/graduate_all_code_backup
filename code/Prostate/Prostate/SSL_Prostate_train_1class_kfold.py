...
parser.add_argument('--patch_size', type=list,  default=[256,256,128], ## brats_2class max_size : 148,188,156
...
if __name__ == "__main__":
    ...
    if args.class_name == 1:
        snapshot_path = "/data/sohui/Prostate/prostate_1c_train_result/{}/{}_{}_fold{}".format(args.exp, args.model,
