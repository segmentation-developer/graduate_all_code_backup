...
from Prostate.networks.nnunet import initialize_network
...
parser.add_argument('--gpu', type=str,  default='5,6,7', help='GPU to use')
parser.add_argument('--add', type=float,  default=1e-8)
parser.add_argument('--temperature', type=float,  default=0.07)
parser.add_argument('--sw_batch_size', type=int,  default=32)
...
def train(args, snapshot_path):
    ...
    train_transforms = Compose(
        [
            ...
            CenterSpatialCropd(keys=['image', 'label'], roi_size=(320,320,32)),
