...
parser.add_argument('--root_path', type=str,
                    default='/data/sohui/Prostate/data/trim/ssl_data', help='Name of Experiment')
...
parser.add_argument('--patch_size', type=list,  default=[144,144,144], ## brats_2class max_size : 148,188,156
...
def train(args, snapshot_path):
    ...
    train_transforms = Compose(
        [
            ...
            RandSpatialCropd(keys=['image', 'label'], roi_size=(300,300,250),random_size=False),
            RandFlipd(
                keys=["image", "label"],
                spatial_axis=[0],
                prob=0.10,
    ...
    ul_train_transforms = Compose(
        [
            ...
            RandSpatialCropd(keys=['image'], roi_size=(300,300,250), random_size=False),
            RandFlipd(
                keys=["image"],
                spatial_axis=[0],
                prob=0.10,
