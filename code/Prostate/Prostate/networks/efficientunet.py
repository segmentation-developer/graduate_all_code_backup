...
from Prostate.networks.efficient_encoder import get_encoder
...
class Effi_UNet(nn.Module):
    ...
    Args:
        encoder_name: name of classification denseUnet_3D (without last dense layers) used as feature
            extractor to build segmentation denseUnet_3D.
        ...
        decoder_attention_type: attention module used in decoder of the denseUnet_3D
            One of [``None``, ``scse``]
        in_channels: number of input channels for denseUnet_3D, default is 3.
        ...
        aux_params: if specified denseUnet_3D will have additional classification auxiliary output
    ...
    def forward(self, x):
        """Sequentially pass `x` trough denseUnet_3D`s encoder, decoder and heads"""
