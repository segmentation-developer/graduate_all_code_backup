...
class Encoder(nn.Module):
    def __init__(self, n_channels, n_classes, n_filters, normalization, has_dropout, drop_rate=0.5):
...
class Decoder_SDM(nn.Module):
    def __init__(self,n_channels, n_classes, n_filters, normalization, has_dropout,drop_rate=0.5):
        super(Decoder_SDM, self).__init__()
        self.has_dropout = has_dropout
        ...
        self.out_conv_1class = nn.Conv3d(n_filters, 1, 1, padding=0)
        self.tanh = nn.Tanh()
    ...
    def forward(self, features):
        ...
        if self.has_dropout:
            x9 = self.dropout(x9)
        out_SDM = self.out_conv_1class(x9)
...
class VNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False):
        ...
        self.decoder = Decoder(n_channels=self.n_channels,
                                    ...
                                    normalization=self.normalization,
                                    has_dropout=self.has_dropout)
        self.decoder_SDM = Decoder_SDM(n_channels=self.n_channels,
                                    n_classes=self.n_classes,
                                    n_filters=self.n_filters,
                                    normalization=self.normalization,
                                    has_dropout=self.has_dropout)
