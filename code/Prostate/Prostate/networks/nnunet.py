...
from Prostate.networks.neural_network import SegmentationNetwork
...
class Generic_UNet(SegmentationNetwork):
    ...
    DEFAULT_PATCH_SIZE_3D = (32,128,128)
...
default_dict = {
    ...
    "net_conv_kernel_sizes": [[3, 3, 1], [3, 3, 1], [3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3]],
    "net_num_pool_op_kernel_sizes": [[2, 2, 1], [2, 2, 1], [2, 2, 2], [2, 2, 2], [2, 2, 1], [2, 2, 1]],
    "net_pool_per_axis": [6, 6, 2],
...
# denseUnet_3D = initialize_network(threeD=True)
# out = denseUnet_3D(input_var)
# print(out.size())