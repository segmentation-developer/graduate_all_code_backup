...
from Prostate.networks.denseUnet.building_blocks.DenseBlock import DenseBlock
from Prostate.networks.denseUnet.building_blocks.TransitionBlock import TransitionBlock
from Prostate.networks.denseUnet.building_blocks.UpsamplingBlock import UpsamplingBlock
...
class DenseUNet3d(nn.Module):
    def __init__(self,n_classes):
        ...
        self.conv1 = nn.Conv3d(
            1, 96, kernel_size=(3,3,3), stride=2, padding=(1,1,1)
        )
        ...
        self.conv_classifier = nn.Conv3d(64, n_classes, kernel_size=1, stride=1)
