...
parser.add_argument('--gpu', type=str,  default='4,5,6', help='GPU to use')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(SL_trainloader):       #0,1 : SL_trainloader(bs:1), UL_trainloader(bs:1)
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                logging.info(
                    'iteration %d : model_dice_score : %f model_class1_dice: %f model_class2_dice: %f  model_hd95 : %f  model_class1_hd95 : %f  model_class2_hd95 : %f' % (
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/sohui/Prostate/prostate_train_result/{}/{}_{}".format(args.exp, args.model,args.max_iterations)
