...
parser.add_argument('--sl_max_iterations', type=int,  default=5000, help='sl max iter')
...
def train(args, snapshot_path):
    ...
    iter_num = 0
    max_epoch = sl_max_iterations // len(trainloader) + 1
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs_2class, outputs_1class_tanh = model(volume_batch[:labeled_bs])  ## model = student
            ...
            supervised_loss = 0.5 * (
                        loss_dice + loss_ce) + loss_sdf  ## (추측)supervised : SDM의 영향 > segmentation 영향 -> SDM loss 적게 반영
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list="val.txt", num_classes=args.num_classes,
                ...
                logging.info(
                    'sl_iteration %d : dice_score : %f hd95 : %f' % (
...
if __name__ == "__main__":
    ...
    snapshot_path = '/data/sohui/BraTS/data/brats_2class_train_result/BraTs19_label_{}_{}/{}/{}_{}_{}_T={}'\
        .format(args.labeled_num, args.total_labeled_num,args.exp,args.model,args.sl_max_iterations,args.max_iterations,args.T)
