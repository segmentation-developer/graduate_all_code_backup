...
from utils import ramps, losses, metrics,test_patch, test_patch_kfold
...
parser.add_argument('--dataset_name', type=str,  default='Brats19', help='dataset_name')
parser.add_argument('--root_path', type=str, default='/data/sohui/BraTS/data/BraTs2019', help='Name of Dataset')
...
parser.add_argument('--labelnum', type=int,  default=28, help='trained samples')
...
parser.add_argument('--fold', type=int,  default=1, help='k fold cross validation')

args = parser.parse_args()

snapshot_path = '/data/sohui/BraTS/data/brats_2class_train_result/BraTs19_label_{}_{}/{}/{}_{}_fold{}' \
    .format(args.labelnum, args.max_samples, args.exp, args.model, args.max_iterations,args.fold)
...
if args.dataset_name == "LA":
    ...
    args.max_samples = 62
elif args.dataset_name == "Brats19":
    patch_size = (96, 96, 96)
    args.max_samples = 250
elif args.dataset_name == "Brats19_kfold":
    patch_size = (96, 96, 96)
    args.max_samples = 268
...
if __name__ == "__main__":
    ...
    if args.dataset_name == "LA":
        ...
        db_train = BraTS2019_kfold(base_dir=train_data_path,
                       split='train',
                       transform = transforms.Compose([
                          RandomCrop(patch_size),
                          ToTensor(),
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num >= 800 and iter_num % 200 == 0:
                ...
                if args.dataset_name =="LA":
                    ...
                    dice_sample = test_patch.var_all_case(model, num_classes=num_classes, patch_size=patch_size,stride_xy=32, stride_z=32, dataset_name='Brats19')
                elif args.dataset_name == "Brats19_kfold":
                    dice_sample = test_patch_kfold.var_all_case(model, num_classes=num_classes, patch_size=patch_size,stride_xy=32, stride_z=32, dataset_name='Brats19_kfold', fold =args.fold)
