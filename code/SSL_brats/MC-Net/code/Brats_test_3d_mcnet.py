...
snapshot_path = '/data/sohui/BraTS/data/brats_2class_train_result/BraTs19_label_{}_{}/{}/{}_{}' \
    .format(FLAGS.labelnum, FLAGS.max_samples, FLAGS.exp, FLAGS.model, FLAGS.max_iterations)
test_save_path = "/data/sohui/BraTS/data/brats_2class_test_result/BraTs19_label_{}_{}/{}/{}_{}" \
    .format(FLAGS.labelnum, FLAGS.max_samples, FLAGS.exp, FLAGS.model, FLAGS.max_iterations)
...
def test_calculate_metric():
    ...
    save_mode_path = os.path.join(snapshot_path, 'iter_29200_dice_0.8585257945704642.pth')
