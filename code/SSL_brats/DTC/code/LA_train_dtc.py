...
snapshot_path = '/data/sohui/LA_dataset/LA_2class_train_result/LA_label_{}_{}/{}/{}_{}'.format(
        args.labelnum, args.total_labeled_num, args.exp, args.model, args.max_iterations)
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            wandb.log({
                ...
                "consistency_loss_sdm2seg": consistency_loss.item()
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list="val.txt", num_classes=num_classes, patch_size=patch_size,
