...
from dataloaders.brats2019 import (BraTS2019, RandomCrop,CenterCrop,
...
parser.add_argument('--labelnum', type=int, default=25, help='random seed')
...
snapshot_path = '/data/sohui/BraTS/data/brats_2class_train_result/BraTs19_label_{}_{}/{}/{}_{}'\
        .format(args.labelnum, args.total_data_num,args.exp,args.model,args.max_iterations)
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list="val.txt", num_classes=num_classes,
