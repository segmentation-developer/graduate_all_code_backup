...
from dataloaders.brats2019_kfold import (BraTS2019, RandomCrop,CenterCrop,
...
snapshot_path = '/data/sohui/BraTS/data/brats_2class_train_result/BraTs19_label_{}_{}/{}/{}_{}_fold{}'\
        .format(args.labelnum, args.total_data_num,args.exp,args.model,args.max_iterations,args.fold)
...
if __name__ == "__main__":
    ...
    unlabeled_idxs = list(range(labelnum, args.total_data_num))
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list="test.txt", num_classes=num_classes,
