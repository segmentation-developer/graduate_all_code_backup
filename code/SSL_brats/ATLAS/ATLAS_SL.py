...
from dataloaders.ATLAS.ATLAS2022_SL import (ATLAS2022, RandomCrop, CenterCrop,
                                               RandomRotFlip, ToTensor,
                                               TwoStreamBatchSampler)

from networks.vnet import VNet
from utils import losses, metrics, ramps
from ATLAS_val_3D_SL import test_all_case

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='/data/sohui/ATLAS/data', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='SL', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=472,
                    help='labeled data')
parser.add_argument('--total_labeled_num', type=int, default=472,
...
def train(args, snapshot_path):
    ...
    db_train = ATLAS2022(base_dir=train_data_path,  # 62 data
                               split='train',
                               num=None,
