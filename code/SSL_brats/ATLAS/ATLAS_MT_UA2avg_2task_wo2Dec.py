...
wandb.init(project="SSL_ATLAS_2class", config={}, reinit=True)
...
if __name__ == "__main__":
    ...
    snapshot_path = '/data/sohui/ATLAS/ATLAS_2class_train_result/ATLAS_label_{}_{}/{}/{}_{}_T={}'.format(args.labeled_num, args.total_labeled_num,args.exp,args.model,args.max_iterations,args.T)
