...
from dataloaders.LA.la_heart import LAHeart, RandomCrop, CenterCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler
#from networks.unet_3D import unet_3D
from networks.vnet_2task_SDM_2Dec import VNet
#from networks.convNext_3D_unet import ConvNeXt
from utils import losses, metrics, ramps
from LA_val_3D_2task import test_all_case
...
parser.add_argument('--exp', type=str,
                    default='MT-UA2avg_2task_SDM_2Dec', help='experiment_name')
...
parser.add_argument('--patch_size', type=list,  default=[112,112,80], ## brats_2class max_size : 148,188,156
...
parser.add_argument('--T', type=int,  default=6, help='ATD iter')
...
wandb.init(project="SSL_LA", config={}, reinit=True)
...
if __name__ == "__main__":
    ...
    snapshot_path = '/data/sohui/LA_dataset/LA_2class_train_result/LA_label_{}_{}/{}/{}_{}_T={}'.format(
        args.labeled_num, args.total_labeled_num, args.exp, args.model, args.max_iterations, args.T)
