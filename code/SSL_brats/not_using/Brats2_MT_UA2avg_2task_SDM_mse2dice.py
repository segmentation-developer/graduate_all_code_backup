...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            consistency_dice =  (dice_loss(outputs_soft_2class[labeled_bs:], seg_avg, target_one_hot_encoder=False))

            loss = supervised_loss + consistency_weight * (consistency_1class_loss + consistency_dice)
