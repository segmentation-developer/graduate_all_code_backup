...
parser.add_argument('--exp', type=str,  default='sassnet_kfold', help='model_name')
...
parser.add_argument('--labelnum', type=int,  default=56, help='random seed')
...
snapshot_path = '/data/sohui/BraTS/data/brats_2class_train_result/BraTs19_label_{}_{}/{}/{}'\
        .format(FLAGS.labelnum, FLAGS.total_labeled_num,FLAGS.exp,FLAGS.model)
...
def test_calculate_metric(epoch_num):
    ...
    save_mode_path = os.path.join(snapshot_path, 'iter_4600_dice_0.7472.pth')
...
if __name__ == '__main__':
    metric = test_calculate_metric(FLAGS.max_iterations)
    print(metric)
