...
from brats_test_3D_util_fully_supervised import test_all_case
...
def Inference(FLAGS, device):
    ...
    save_mode_path = os.path.join(
        snapshot_path, 'iter_18400_dice_0.8253.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp', type=str,
                        default='kfold/GDT-MT_woSDM', help='experiment_name')
    parser.add_argument('--model', type=str, default='vnet_3D_96_32_30000_T=6_fold5_consisW1.0', help='model_name')
