...
python LA_MT_UA2avg_2task_SDM_2Dec.py --exp='MT_UA2avg_2task_SDM_dualD' --model=noise0.3_vnet_3D_112_112_80_18_4 --max_iterations=30000 --batch_size=4 --labeled_bs=2 --labeled_num=16 --num_classes=2 --gpu=1 --T=8
