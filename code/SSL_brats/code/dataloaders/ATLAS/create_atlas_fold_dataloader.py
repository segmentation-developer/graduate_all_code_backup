...
train_label_patient_names = patient_names[:138]
train_unlabel_patient_names = patient_names[138:388]
val_patient_names = patient_names[388:464]
test_patient_names = patient_names[464:]

f = open("/home/psh/data/ATLAS_2/label_unlabel_integrated_data/20%_label/train_label_20percent.txt", 'w')
...
f = open("/home/psh/data/ATLAS_2/label_unlabel_integrated_data/20%_label/train_unlabel_20percent.txt", 'w')
...
f = open("/home/psh/data/ATLAS_2/label_unlabel_integrated_data/20%_label/train_unlabel_20percent.txt", 'a')
