...
class LAHeart(Dataset):
    """ LA Dataset """
    def __init__(self, base_dir=None, split='train', num=None, transform=None, train_idx =None):
        ...
        total_path = self._base_dir + '/total.list'
        ...
        print("total {} samples , train {} samples".format(len(self.image_list), len(self.train_idx)))

    def __len__(self):
        return len(self.image_list)

    def __getitem__(self, idx):
        if self.train_idx[0] <= idx <= self.train_idx[-1] :
