...
def Inference(FLAGS, device):
    ...
    test_save_path = "/data/sohui/BraTS/data/brats_2class_test_result/BraTs19_label_{}_{}/{}_trainResult/{}" \
        .format(FLAGS.labeled_num, FLAGS.total_labeled_num, FLAGS.exp, FLAGS.model)
    ...
    save_mode_path = os.path.join(
        snapshot_path, 'iter_6400_dice_0.8359.pth')
    #save_mode_path = os.path.join(
    #    snapshot_path, '{}_best_model.pth'.format(FLAGS.model))
    net.load_state_dict(torch.load(save_mode_path))
    print("init weight from {}".format(save_mode_path))
    net.eval()
    avg_metric = test_all_case(net, base_dir=FLAGS.root_path, method=FLAGS.model, test_list="train.txt", num_classes=num_classes,
                               patch_size=(128,128,128), stride_xy=32, stride_z=32, save_result=True, test_save_path=test_save_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp', type=str,
                        default='MT_UA2avg_2task_SDM_mse2dice', help='experiment_name')
    parser.add_argument('--exp_test', type=str,
                        default='MT_UA2avg_2task_SDM_mse2dice', help='experiment_name')
    parser.add_argument('--model', type=str,
                        default='vnet_3D_128_20000', help='model_name')
