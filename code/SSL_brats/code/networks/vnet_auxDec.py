...
class VNet_auxDec(nn.Module):
    def __init__(self, has_dropout=True):
        super(VNet_auxDec, self).__init__()
    ...
    def forward(self, input, mode='dec'):
...
if __name__ == '__main__':
    ...
    model = VNet_auxDec(n_channels=1, n_classes=2)
