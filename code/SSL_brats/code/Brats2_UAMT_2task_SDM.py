...
from networks.vnet_2task_SDM import VNet
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            with torch.no_grad():
                ema_output,ema_output_1class_tanh = ema_model(ema_inputs)              ##ema model = teacher
            ...
            for i in range(T // 2):
                ...
                with torch.no_grad():
                    preds[2 * stride * i:2 * stride * (i + 1)],__ = ema_model(
            ...
            consistency_1class_loss = mse_loss(outputs_1class_tanh[labeled_bs:], ema_output_1class_tanh)       ## (2,1,96,96,96)
