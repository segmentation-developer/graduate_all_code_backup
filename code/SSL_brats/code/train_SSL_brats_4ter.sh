...
####여기서부터 돌리면 됨
#python Brats2_GDT_MT_kfold.py --exp='kfold/GDT-MT' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=28 --consistency=0.5 --num_classes=2 --gpu=3 --T=6 --fold=5
...
#python Brats2_GDT_MT_woSDM_kfold.py --exp='kfold/GDT-MT_woSDM' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=28 --consistency=1.0 --num_classes=2 --gpu=3 --T=6 --fold=5 &&
#python Brats2_GDT_MT_woSDM_kfold.py --exp='kfold/GDT-MT_woSDM' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=56 --consistency=1.0 --num_classes=2 --gpu=3 --T=6 --fold=5
python Brats2_GDT_MT_kfold.py --exp='kfold/GDT-MT_opti' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=56 --consistency=1.0 --num_classes=2 --gpu=3 --T=6 --fold=3 &&
python Brats2_GDT_MT_kfold.py --exp='kfold/GDT-MT_opti' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=56 --consistency=1.0 --num_classes=2 --gpu=3 --T=6 --fold=4
...
#python Brats2_fully_supervised_kfold.py --exp='fully_supervised_kfold' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=268 --num_classes=2 --gpu=2 --fold=1 &&
#python Brats2_fully_supervised_kfold.py --exp='fully_supervised_kfold' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=268 --num_classes=2 --gpu=2 --fold=2 &&
#python Brats2_fully_supervised_kfold.py --exp='fully_supervised_kfold' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=268 --num_classes=2 --gpu=2 --fold=3 &&
#python Brats2_fully_supervised_kfold.py --exp='fully_supervised_kfold' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=268 --num_classes=2 --gpu=2 --fold=4 &&
#python Brats2_fully_supervised_kfold.py --exp='fully_supervised_kfold' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=268 --num_classes=2 --gpu=2 --fold=5
