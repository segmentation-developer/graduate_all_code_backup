...
#python Brats2_GDT_MT_kfold.py --exp='kfold/GDT-MT' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=28 --consistency=1.0 --num_classes=2 --gpu=4 --T=2 --fold=5
python Brats2_GDT_MT_woATO_kfold.py --exp='kfold/GDT-MT' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=28 --consistency=1.0 --num_classes=2 --gpu=5 --T=1 --fold=5 &&
python Brats2_GDT_MT_woATO_kfold.py --exp='kfold/GDT-MT' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=56 --consistency=1.0 --num_classes=2 --gpu=5 --T=1 --fold=5
