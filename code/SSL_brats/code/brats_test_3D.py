...
def Inference(FLAGS, device):
    ...
    save_mode_path = os.path.join(
        snapshot_path, 'iter_11000_dice_0.8669.pth')
    ...
    return avg_metric, avg_uncertainty
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp', type=str,
                        default='GDT-MT', help='experiment_name')
    parser.add_argument('--model', type=str, default='vnet_3D_96_32_30000_T=2', help='model_name')
    ...
    metric, avg_uncertainty = Inference(FLAGS, device=device)
    print(metric, 'avg_uncertainty : {}'.format(avg_uncertainty))
