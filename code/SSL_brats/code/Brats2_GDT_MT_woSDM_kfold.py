...
from dataloaders.brats.brats2019_kfold import (BraTS2019, RandomCrop,CenterCrop,
...
from brats_val_3D_kfold import test_all_case
...
parser.add_argument('--labeled_num', type=int, default=28,
                    help='labeled data')
parser.add_argument('--total_labeled_num', type=int, default=268,
...
wandb.run.name = 'BraTs19_label_{}_{}/{}/{}_{}_T={}_fold{}_consisW{}'\
    .format(args.labeled_num, args.total_labeled_num,args.exp,args.model,args.max_iterations,args.T,args.fold,args.consistency)

if args.consistency_rampup == 0.0 :
    consistency_rampup =  (args.max_iterations // ((args.total_labeled_num-args.labeled_num)//args.labeled_bs)) *80 // 300
else :
    consistency_rampup = args.consistency_rampup

def get_current_consistency_weight(epoch):
    # Consistency ramp-up from https://arxiv.org/abs/1610.02242
    return args.consistency * ramps.sigmoid_rampup(epoch, consistency_rampup)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            for i in range(T // 2):
                ...
                with torch.no_grad():
                    preds[2 * stride * i:2 * stride * (i + 1)] = ema_model(ema_inputs)  ## unlabel의 shape를 *2로 복사한 값에 새로운 noise를 >계속 넣어줘서 teacher model에 계속 실험  -> preds에 계속 결과 쌓기
            ...
            supervised_loss = 0.5 * (loss_dice + loss_ce )      ## (추측)supervised : SDM의 영향 > segmentation 영향 -> SDM loss 적게 반영

            #####################################################################################################unsupervised loss
            #consistency_weight = get_current_consistency_weight(iter_num // (args.max_iterations / args.consistency_rampup))
            #consistency_weight = get_current_consistency_weight(iter_num // 150)
            consistency_weight = get_current_consistency_weight(iter_num // ((args.total_labeled_num-args.labeled_num)//args.labeled_bs))
            ...
            loss = supervised_loss + consistency_weight * (consistency_mse)
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list="test.txt", num_classes=args.num_classes, patch_size=args.patch_size,
                    stride_xy=32, stride_z=32,fold=args.fold)
...
if __name__ == "__main__":
    ...
    snapshot_path = '/data/sohui/BraTS/data/brats_2class_train_result/BraTs19_label_{}_{}/{}/{}_{}_T={}_fold{}_consisW{}'\
        .format(args.labeled_num, args.total_labeled_num,args.exp,args.model,args.max_iterations,args.T,args.fold,args.consistency)
