...
#python train_LA_meanteacher_certainty_unlabel.py --exp='UAMT_original' --model=vnet_3D_96 --max_iterations=30000 --labeled_num=25 --num_classes=2
python Brats_train_UA-MT_kfold.py --exp='UAMT_kfold' --model=vnet_3D_96_32 --max_iterations=30000 --labeled_num=56 --num_classes=2 --gpu=2 --fold=5
