...
class ATLAS2022(Dataset):
    ...
    def __init__(self, base_dir=None, split='train', num=None, transform=None):
        ...
        train_path = self._base_dir+'/SL/size_balanced/train.txt'
        test_path = self._base_dir+'/SL/size_balanced/test.txt'
    ...
    def __getitem__(self, idx):
        ...
        label = nib.load(self._base_dir + "/labels" + "/{}".format(image_name))
