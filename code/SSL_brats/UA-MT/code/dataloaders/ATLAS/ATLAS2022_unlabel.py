...
class ATLAS2022_unlabel(Dataset):
    """ ALTAS2022 Dataset """
    ...
    def __init__(self, base_dir=None, split='train', num=None, transform=None):
        ...
        train_path = self._base_dir+'/train_unlabel.txt'
    ...
    def __getitem__(self, idx):
        ...
        image = nib.load(self._base_dir + "/images" + "/{}".format(image_name))
...
class CenterCrop_unlabel(object):
...
class RandomCrop_unlabel(object):
    """
    ...
    def __call__(self, sample):
        ...
        if self.with_sdf:
            sdf = sdf[w1:w1 + self.output_size[0], h1:h1 +
                      self.output_size[1], d1:d1 + self.output_size[2]]
            return {'image': image, 'sdf': sdf}
        else:
            return {'image': image}


class RandomRotFlip_unlabel(object):
    """
